...
#include "tup_conf_extenddef.h"
	...
	*****************************************************************************/	
	TUP_API TUP_RESULT  tup_conf_video_snapshot(CONF_HANDLE handle, TUP_UINT32 deviceid, const TUP_CHAR* filename, TC_VIDEO_PARAM* vparam); 
		...
		/*****************************************************************************
	函 数 名  : tup_conf_video_render_snapshot
	功能描述  : 显示的视频(Render)拍照功能。需要视频是打开着的
	输入参数  : handle: 会议句柄
				userid: 用户ID
				deviceid: 设备ID
				filename: 图片保存的文件路径
	...
	回调消息  : 无
	*****************************************************************************/	
	TUP_API TUP_RESULT  tup_conf_video_render_snapshot(CONF_HANDLE handle, TUP_UINT32 userid, TUP_UINT32 deviceid, const TUP_CHAR* filename);
	...
	*****************************************************************************/	
	...
	/*****************************************************************************
	函 数 名  : tup_conf_video_wizstart_render
	功能描述  : 在向导中显示视频
	输入参数  : deviceid: 设备ID
				pWnd:	窗口句柄
	...
	回调消息  : 无
	*****************************************************************************/	
	TUP_API TUP_RESULT  tup_conf_video_wizstart_render(TUP_UINT32 deviceid, void* pWnd);

	/*****************************************************************************
	函 数 名  : tup_conf_video_wizend_render
	功能描述  : 关在向导中关闭视频
	输入参数  : deviceid: 设备ID
				pWnd:	窗口句柄(可以为空)
	...
	回调消息  : 无
	*****************************************************************************/	
	TUP_API TUP_RESULT  tup_conf_video_wizend_render(TUP_UINT32 deviceid, void* pWnd);

	/*****************************************************************************
	函 数 名  : tup_conf_video_wizset_capture_rotate
	功能描述  : 设置向导中视频采集的旋转角度
	输入参数  : deviceid: 设备ID
				iRotate:  旋转角度 
	...
	回调消息  : 无
	*****************************************************************************/	
	TUP_API TUP_RESULT  tup_conf_video_wizset_capture_rotate(TUP_UINT32 deviceid, int iRotate);
...
/*****************************************************************************
	...
	*****************************************************************************/	
	...
	TUP_API TUP_RESULT  tup_conf_video_create_rtp_device(CONF_HANDLE handle,const TUP_CHAR* devicename,TUP_UINT16 devicetype,TUP_UINT32* ret_deviceid);	


	/*****************************************************************************
	函 数 名  : tup_conf_video_open_rtp
	功能描述  : 打开一个RTP视频设备
	输入参数  : listen_addr : UDP监听地址
				listen_port: UDP监听端口
	输出参数  : 无
	返 回 值  : 返回TC_OK表示成功，其它表示失败
	回调消息  : 无
	*****************************************************************************/	
	...
	TUP_API TUP_RESULT  tup_conf_video_open_rtp(CONF_HANDLE handle,TUP_UINT32 deviceid, const TUP_CHAR* listen_addr,TUP_UINT16 listen_port);	
