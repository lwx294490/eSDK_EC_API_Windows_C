...
//注意：接口字符串都采用UTF8格式
	...
	回调消息  : 无
	*****************************************************************************/	
    TUP_API TUP_VOID  tup_conf_init(TUP_BOOL selfthread, const Init_param * pinitparam);
	...
	*****************************************************************************/	
	...
	/*****************************************************************************
	函 数 名  : tup_conf_init_isv
	功能描述  : 初始化ISV信息
	输入参数  : bpaasmode:是否启用PaaS模式
				  pisv_param：ISV信息
	输出参数  : 无
	返 回 值  : 无
	回调消息  : 无
	*****************************************************************************/	
	TUP_API TUP_VOID  tup_conf_init_isv(TUP_BOOL bpaasmode, const Isv_Param* pisv_param);
	/*****************************************************************************
	函 数 名  : tup_conf_new
	功能描述  : 新建一个会议对象。
	...
	*****************************************************************************/  
	...
	/*****************************************************************************
	函 数 名  : tup_conf_paas_join
	功能描述  : 在公有云场景下，加入一个会议
	输入参数  : handle: 会议句柄 , token :MAM分配的Token明文
	输出参数  : 无
	返 回 值  : 返回TC_OK表示成功，其它表示失败
	回调消息  : CONF_MSG_ON_CONFERENCE_JOIN  
	CONF_MSG_USER_ON_ENTER_IND 
	...
	CONF_MSG_USER_ON_PRESENTER_CHANGE_IND
	*****************************************************************************/  
	TUP_API TUP_RESULT  tup_conf_paas_join(CONF_HANDLE handle,const TUP_CHAR* token);
	...
	*****************************************************************************/  
	...
	/*****************************************************************************
	函 数 名  : tup_conf_set_component_option
	功能描述  : 设置指定组件的参数
	输入参数  : handle: 会议句柄 ,
				compts : 组件ID ，对应COMPONENT_IID枚举值
				option_type：参数类型
	...
	回调消息  : 无
	*****************************************************************************/  
	TUP_API TUP_RESULT  tup_conf_set_component_option(CONF_HANDLE handle, TUP_UINT32 compt,TUP_UINT32 option_type,void* option,TUP_UINT32 len);
