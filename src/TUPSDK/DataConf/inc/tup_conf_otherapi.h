...
				COMPT_MSG_AUDIO_ON_AUDIO_OPEN_MIC
	...
	*****************************************************************************/	
	...
	回调消息  : 无
	*****************************************************************************/	
	TUP_API TUP_UINT32  tup_conf_get_nodeid_byuserid(CONF_HANDLE handle, TUP_UINT32 userid); 
	...
	回调消息  : 无
	*****************************************************************************/	
	TUP_API TUP_UINT32  tup_conf_get_userid_bynodeid(CONF_HANDLE handle, TUP_UINT32 nodeid); 
	...
	回调消息  : 无
	*****************************************************************************/	
	TUP_API TUP_RESULT  tup_conf_handle_json(CONF_HANDLE confHandle, TUP_UINT32 nMsgType, const TUP_CHAR *szJson);
#ifdef __cplusplus
};
